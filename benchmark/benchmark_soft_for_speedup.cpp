...
int main(int argc, const char** argv)
{
    ...
    // write to file
    FILE* fp  = fopen("benchmark_soft_for_speedup.txt", "w");
    FILE* fp2 = fopen("soft_forward_speedup.dat", "w");
    
    // Print to console
    printf("+--------------------------------------------------------------------------------------+\n");
    printf("|                            SOFT FORWARD SPEEDUP BENCHMARK                            |\n");
    printf("+--------------------------------------------------------------------------------------+\n");
    ...
    // Print to file
    fprintf(fp, "+--------------------------------------------------------------------------------------+\n");
    fprintf(fp, "|                            SOFT FORWARD SPEEDUP BENCHMARK                            |\n");
    fprintf(fp, "+--------------------------------------------------------------------------------------+\n");
